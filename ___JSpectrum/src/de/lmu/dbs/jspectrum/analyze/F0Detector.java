package de.lmu.dbs.jspectrum.analyze;

/**
 * Basic f0 detection, based on Anssi Klapuris iterative algorithm. Needs CQT input.
 * 
 * <br><br>
 * <span style="color:red">
 * <b>NOTE:</b> This class is not optimized at all - performance is bad, the threshold 
 * algorithm is not suitable to detect wrong f0s etc. etc. <br>
 * <br>
