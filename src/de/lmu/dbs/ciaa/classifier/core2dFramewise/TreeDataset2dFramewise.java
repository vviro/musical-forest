 ...
 *
 */
public abstract class TreeDataset2dFramewise extends TreeDataset {

	public TreeDataset2dFramewise(File dataFile, File referenceFile) throws Exception {
	...
	public synchronized Object getInitialClassification(final int valuesPerFrame) throws Exception {
		throw new Exception("Values per frame do not make sense in 2dFramewise");
	}
