 ...
 *
 */
public class MCForest {

	/**
	 * The trees of the forest
	 */
	protected List<MCTree> trees;
	 ...
	 * @throws Exception 
	 */
	public MCForest(List<MCTree> trees, final ForestParameters params) throws Exception {
		this.params = params;
		// Generate trees
	 ...
	 */
	public MCForest() {
		this.trees = new ArrayList<MCTree>();
	}
	...
	public void logTreeStats() throws Exception {
		...
		MCTreeAnalyzer ana = new MCTreeAnalyzer(params);
		for(int i=0; i<trees.size(); i++) {
			MCTree t = trees.get(i);
	...
	public static MCForest load(final String filename, final int numTrees) throws Exception {
		...
		for(int i=0; i<numTrees; i++) {
			f.trees.add(MCRandomTree.load(filename + "_tree" + i)); // TODO Type tree / randomtree
		}
		return f;
	}
