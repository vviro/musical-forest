 ...
 *
 */
public abstract class MCTree extends Thread {
	 ...
	 */
	protected MCForest forest;
	
	/**
	 * The actual tree structure
	 */
	protected MCNode tree = new MCNode();
	 ...
	 */
	protected MCTree newThreadRoot;
	
	/**
	 * The attributes with prefix "newThread" are used to transport parameters
	 * to new Threads (see growRec source code)
	 */
	protected MCNode newThreadNode;
	 ...
	 * to new Threads (see growRec source code)
	 */
	protected double newThreadNoteRatio;
	 ...
	 * @throws Exception 
	 */
	protected abstract void growRec(MCTree root, final Sampler<Dataset> sampler, List<byte[][]> classification, final MCNode node, final int mode, final int depth, final int maxDepth, boolean multithreading, double noteRatio) throws Exception;
	 ...
	 * @param forest
	 */
	public void setForest(MCForest forest) {
		this.forest = forest;
	}
	...
	public void run() {
		try {
			...
			growRec(newThreadRoot, newThreadSampler, newThreadClassification, newThreadNode, newThreadMode, newThreadDepth, newThreadMaxDepth, false, newThreadNoteRatio);
