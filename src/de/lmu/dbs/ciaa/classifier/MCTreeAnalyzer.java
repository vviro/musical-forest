...
public class MCTreeAnalyzer {
	 ...
	 * @throws Exception
	 */
	public MCTreeAnalyzer(ForestParameters params) throws Exception {
		this.params = params;
	}
	 ...
	 */
	public void visualize(MCTree rtree, int[][] data) {
	 ...
	 * @return
	 */
	public int getNumOfLeafs(MCTree rtree) {
	 ...
	 * @return
	 */
	private int getNumOfLeafs(MCNode node) {
	 ...
	 * @return
	 */
	public int[] getDepthCounts(MCTree rtree) {
	 ...
	 * @param depth
	 */
	private void getDepthCountsRec(MCNode node, int[] counts, int depth) {
		counts[depth]++;
		if (!node.isLeaf()) {
	 ...
	 * @return
	 */
	public String getDepthCountsString(MCTree rtree) {
		String ret = "";
	 ...
	 * @return
	 */
	public String getTreeVisualization(MCTree rtree) {
	 ...
	 * @return
	 */
	private void getTreeVisualizationRec(MCNode node, String[] s, int mode, int part, int depth, int all) {
