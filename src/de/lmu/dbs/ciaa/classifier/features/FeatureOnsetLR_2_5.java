 ...
 *
 */
public class FeatureOnsetLR_2_5 extends Feature2d {
	 ...
	 * 
	 */
	public FeatureOnsetLR_2_5(final ForestParameters params) {
		initStatic();
	...
	public List<Object> getRandomFeatureSet(ForestParameters params) {
		...
		for(int i=0; i<params.numOfRandomFeatures; i++) {
			FeatureOnsetLR_2_5 n = new FeatureOnsetLR_2_5(params);
			ret.add(n);
		}
		return ret;
	}
	...
	public Feature2d getInstance(ForestParameters params) {
		return new FeatureOnsetLR_2_5(params);
	}
}