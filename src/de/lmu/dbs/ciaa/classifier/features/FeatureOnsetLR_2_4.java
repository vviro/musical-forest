 ...
 *
 */
public class FeatureOnsetLR_2_4 extends Feature2d {
	...
	public int maxNumOfOvertones = 10; // TODO -> params
...
//	public float harmonicAmplification = 1.0f; // TODO -> params
	 ...
	 * 
	 */
	public FeatureOnsetLR_2_4(final ForestParameters params) {
		initStatic();
		numOfOvertones = RandomUtils.randomInt(maxNumOfOvertones);
	...
	public List<Object> getRandomFeatureSet(ForestParameters params) {
		...
		for(int i=0; i<params.numOfRandomFeatures; i++) {
			FeatureOnsetLR_2_4 n = new FeatureOnsetLR_2_4(params);
			ret.add(n);
		}
		return ret;
	}
	...
	public String toString() {
		String ret = "LR: uX: " + uX + ", vX: " + vX + ", Harmonics: (num: " + chosenHarmonics.length + ") {";
	...
	public Feature2d getInstance(ForestParameters params) {
		return new FeatureOnsetLR_2_4(params);
	}
}