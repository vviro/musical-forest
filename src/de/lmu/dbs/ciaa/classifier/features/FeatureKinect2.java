 ...
 *
 */
public class FeatureKinect2 extends Feature {
	 ...
	 * 
	 */
	public FeatureKinect2(int xMin, int xMax, int yMin, int yMax, int thresholdMax) {
	 ...
	 * 
	 */
	public FeatureKinect2(FeatureKinect2 f, int thresholdMax) {
		this.uX = f.uX;
		this.uY = f.uY;
		this.vX = f.vX;
		this.vY = f.vY;
	...
	public static List<Feature> getRandomFeatureSet(RandomTreeParameters params) {
		...
		for(int i=0; i<params.numOfRandomFeatures; i++) {
			FeatureKinect2 n = new FeatureKinect2(params.xMin, params.xMax, params.yMin, params.yMax, params.thresholdMax);
			ret.add(n);
			for(int j=0; j<params.thresholdCandidatesPerFeature-1; j++) {
				ret.add(new FeatureKinect2(n, params.thresholdMax));
			}
		}
		return ret;
